...
export class GdmLiveAudioVisuals3D extends LitElement {
  ...
  @state() declare webGLAvailable = true;
  ...
  static styles = css`
    ...
    .fallback-orb {
      width: 200px;
      height: 200px;
      background: radial-gradient(circle, rgba(0,255,255,0.8) 0%, rgba(0,0,0,0) 70%);
      border-radius: 50%;
      position: absolute;
      top: 50%;
      left: 50%;
  ...
  connectedCallback() {
    ...
    console.log('GdmLiveAudioVisuals3D: connectedCallback called');
  }
